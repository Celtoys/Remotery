...
{
	function TitleWindow(wm, settings, connection_address)
	{
		...
		this.EditBox = this.Window.AddControlNew(new WM.EditBox(10, 5, 300, 18, "Connection Address Pattern", connection_address));
	...
	TitleWindow.prototype.OnPing = function(server_id, servers_length)
	{
		// Set the ping container as active and take it off half a second later
		DOM.Node.AddClass(this.PingContainer.Node, "PingContainerActive");
